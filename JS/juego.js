...
class Animal {
    constructor(animalX, animalY, animalImage, casaX, casaY, casaImage, bandera, animalSound) {
        ...
        this.animalSound = animalSound; // Ruta del archivo de sonido del animal
        this.sonidoReproducido = false; // Nuevo atributo para controlar si el sonido del animal ya ha sido reproducido
    }
...
let opciones = [
  new Animal(0, 250, "./Imagenes/mono.png", 0, 25, "./Imagenes/HabitadMono.png", false, "Sonidos/SonidoMono.mp3"),
  new Animal(0, 250, "./Imagenes/Caballo.png", 0, 25, "./Imagenes/HabitadCaballo.png", false, "Sonidos/SonidoCaballo.mp3"),
...
let mouse_up = function (event) {
    ...
    // Restablece el estado del sonido reproducido del animal
    animales[current_animal_index].sonidoReproducido = false;
};
...
function reproducirSonidoAnimal(animal) {
    if (!animal.sonidoReproducido) {
        var audio = new Audio(animal.animalSound); // Suponiendo que tienes un atributo 'animalSound' en tu clase Animal que contiene la ruta del archivo de sonido
        audio.play();
